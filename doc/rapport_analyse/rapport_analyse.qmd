...
Les classes liées aux utilisateurs permettront essentiellement de créer les utilisateurs et de gérer leur rôle (utilisateur ou administrateur). La classe modèle est la classe ```User```. Les autres classes seront essentiellement fonctionnelles et permettront de gérer la connexion et la base de données. Voici le diagramme de classes prévu :  

![Diagramme de classes lié aux utilisateurs](img/diag_classes_user.png)  
...
![Diagramme de séquence de la fonctionnalité "ajouter une station favorite"](img/diag_sequence.png)
